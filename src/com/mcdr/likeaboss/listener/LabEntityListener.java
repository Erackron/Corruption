<<<<<<< HEAD:src/com/mcdr/likeaboss/listener/LabEntityListener.java
...
public class LabEntityListener implements Listener {
	...
	public void onCreatureSpawn(CreatureSpawnEvent event) {
		...
		if(bossData.getMaxSpawnLevel() < event.getLocation().getY())
			return;
...
>>>>>>> origin/EquipmentExpansion:src/com/mcdr/likeaboss/listener/LabEntityListener.java
