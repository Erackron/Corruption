...
public abstract class Ability {
    ...
    public boolean checkChance() {
        return (MathUtil.random.nextInt(100) < this.getActivationChance());
    }
    ...
    public void useCooldown(Boss boss) {
        ...
        Corruption.scheduler.scheduleSyncDelayedTask(Corruption.getInstance(), new AbilityReactivator(boss, this), (long) (cooldown * 20));
    }
    ...
    public void sendAreaMessage(Location loc, String bossName, LivingEntity fixedTarget) {
        ...
        for (CorPlayer corPlayer : CorPlayerManager.getCorPlayers()) {
            ...
            if (player.equals(target))
                continue;
            if (MathUtil.isNear(player.getLocation(), loc, 0, messageRadius)) {
    ...
    public String parseMsg(String msg, String bossName) {
        return MessageUtil.parseMessage(msg, bossName);
    }
