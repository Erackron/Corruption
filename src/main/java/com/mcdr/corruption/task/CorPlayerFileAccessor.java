...
public class CorPlayerFileAccessor implements Runnable {
    private static final String filePath = Corruption.getInstance().getDataFolder().getPath() + File.separator + "players.dat";
    ...
    private void savePlayers() throws Exception {
        ...
        FileUtil.fileToFile(file, tempFile);
        ...
        for (Entry<Short, List<CorPlayer>> entry : this.playersToLoad.entrySet()) {
            ...
            if (toLoad == null) {
                while (scanner.hasNextLine()) {
                    ...
                    CorPlayer = new CorPlayer(Corruption.getInstance().getServer().getOfflinePlayer(name));
                ...
                while (scanner.hasNextLine()) {
                    ...
                    Iterator<CorPlayer> localIterator2 = toLoad.iterator();
                    if (localIterator2.hasNext()) {
                        CorPlayer = localIterator2.next();
